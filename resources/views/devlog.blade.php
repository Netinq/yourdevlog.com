...
<div class="articles-content col-sm-8">
  <iframe id="yourdevlog_iframe" title="YourDevlog : YourDevlog" width="100%" height="100%" allowfullscreen=true style="border: none;" src="http://127.0.0.1:8000/data/{{$data_url}}">
</div>
@endsection
