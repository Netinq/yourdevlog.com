  ...
  <div class="website">
    <div class="box-web">
      ...
      <div class="box-body">
        ...
        <div class="info">
          <p>Créer de nouveaux articles afin que les professeurs puissent suivre votre progression. Un article devra être composé des dernières modifications éffectués au programme, ainsi que d'un rapport sur ce que vous avez fait</p>
        </div>
      </div>
    </div>
  </div>
